...
public class VerifySubscription
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                _logger.LogWarning("Newsletter subscription verified for {Email}, but sending the welcome email failed. ErrorType: {ErrorType}", subscriber.Email, emailEx.GetType().Name);
            }
