...
![From Prompts to Specifications](https://dsanchezcrwebsite.blob.core.windows.net/images/blog/2026-02-20-FromPromptstoSpects/from-prompts-to-spects.jpg)
...
- 🤖 Agent-specific guidance (`.github/copilot-instructions.md`)
