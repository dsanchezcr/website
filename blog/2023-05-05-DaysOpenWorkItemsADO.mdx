...
Then you can select the filters that you want to apply to the view, in this case, since this is a test project I selected all history and you can see the warning message on top about the amout of data. In this section you can also exclude the work items that were completed before the date that you choose.

Once the view is verfied and created, we are ready to open Power BI, in my case I used the Power BI Desktop application.
