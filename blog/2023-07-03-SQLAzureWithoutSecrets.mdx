...
With GitHub Advanced Security, you can scan your code for secrets and vulnerabilities in your codebase and git history by using [Secret Scanning](https://docs.github.com/code-security/secret-scanning/about-secret-scanning) or even go one step further and use [push protection](https://docs.github.com/enterprise-cloud@latest/code-security/secret-scanning/protecting-pushes-with-secret-scanning) to avoid secrets being pushed in your repository. These is a great feature, but it is not enough. You need to protect your secrets, and you need to rotate them. In this post I will show you how to connect to SQL Azure without using secrets, using Azure Active Directory. This applies to users, managed identities and service principals.
