...
> You will need to create the Azure Automation account and Run as Account to connect with the Azure Resources. You can follow the steps in this [article](https://learn.microsoft.com/azure/automation/learn/powershell-runbook-managed-identity#assign-permissions-to-managed-identities).
