...
const translations = {
  en: {
    ...
    noSubscription: 'No subscription found. Please check your link.',
  ...
  es: {
    ...
    noSubscription: 'No se encontró una suscripción. Verifica tu enlace.',
  ...
  pt: {
    ...
    noSubscription: 'Nenhuma assinatura encontrada. Verifique seu link.',
