...
:::tip All projects are open source
All my projects are available on [GitHub](https://github.com/dsanchezcr). Feel free to contribute, fork, or use them for learning!
:::
...
## Issue Importer Action {#issue-importer}
...
## Colones Exchange Rate {#colones-exchange-rate}
...
## Contact Form with Azure {#contact-form}
...
[![Contact Form](../../static/img/blog/2023-04-23-BuildContactForm/ContactFormResult.jpg)](https://github.com/dsanchezcr/ContactFormWithAzure)

## Load Testing Demo {#load-testing}
...
## Projects from Previous Roles {#previous-roles}
...
### Sample Delivery Service {#sample-delivery-service}
...
### Tailwind Traders {#tailwind-traders}
