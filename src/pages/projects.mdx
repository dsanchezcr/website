...
[![Icon](../../static/img/ColonesExchangeRate/Icon.png)](https://github.com/dsanchezcr/ColonesExchangeRate)

## Build a simple contact form (Azure Communication Services, Azure Functions & GitHub Actions)

This is a demo repository about how to build a simple contact form. Check it out [here](https://purple-sky-05cd51e0f.3.azurestaticapps.net/Index.html).

[Check out the blog post about this repository](https://xpirit.com/building-a-simple-contact-form).

[![Contact Roles](../../static/img/BuiltContactForm/ContactFormResult.jpg)](https://github.com/dsanchezcr/ContactFormWithAzure)
