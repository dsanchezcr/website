...
const translations = {
  en: {
    ...
    prints: [
      {
        title: 'DK Bananza',
        image: 'https://dsanchezcrwebsite.blob.core.windows.net/images/3dprinting/dk-bananza.jpg',
      ...
      },
      {
        ...
        image: 'https://dsanchezcrwebsite.blob.core.windows.net/images/3dprinting/fallout-controller-holder.jpg',
        printer: 'Bambu Lab P1S',
        filament: 'PLA',
      ...
      },
      {
        ...
        image: 'https://dsanchezcrwebsite.blob.core.windows.net/images/3dprinting/chico-a-bordo.jpg',
        printer: 'Bambu Lab P1S',
        filament: 'PLA',
