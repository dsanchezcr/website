...
const translations = {
  en: {
    ...
    chatSubtitle: "Powered by Microsoft Foundry (Claude)",
    ...
    fallbackResponse: (query) => `Thanks for your question about "${query}". The NLWeb backend is currently being set up with Microsoft Foundry and Claude integration. Meanwhile, you can explore David's blog for insights on Azure technologies, developer productivity, and his latest projects. Check out the blog, projects, and about sections to learn more!`
  },
  es: {
    chatTitle: "Pregúntame sobre mi sitio web",
    chatSubtitle: "Impulsado por Microsoft Foundry (Claude)",
