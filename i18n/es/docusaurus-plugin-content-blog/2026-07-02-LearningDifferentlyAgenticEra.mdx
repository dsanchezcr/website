...
Los sistemas educativos tradicionales surgieron en un mundo donde la información era escasa y lenta de alcanzar. Los libros eran costosos, las bibliotecas eran limitadas y los expertos eran difíciles de acceder. En ese mundo, memorizar datos, fórmulas y procedimientos era genuinamente valioso, porque recordar información rápidamente era a menudo el cuello de botella para poder usarla.
