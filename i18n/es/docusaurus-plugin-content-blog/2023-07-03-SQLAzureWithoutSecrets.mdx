...
- [SQL Azure: uso de la autenticación de Azure Active Directory](https://learn.microsoft.com/azure/azure-sql/database/authentication-aad-overview?WT.mc_id=DT-MVP-5005361)