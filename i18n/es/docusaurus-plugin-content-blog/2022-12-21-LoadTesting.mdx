...
Si desea obtener más información sobre Azure Load Testing, le recomiendo que revise el [Documentación de servicio](https://learn.microsoft.com/azure/load-testing?WT.mc_id=DT-MVP-5005361).