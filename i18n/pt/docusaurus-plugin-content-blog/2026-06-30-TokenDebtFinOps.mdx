...
| Respostas de ferramentas | Dados retornados por uma chamada de ferramenta concluída | Retorno da resposta inteira em vez apenas dos campos que a tarefa realmente precisa |
