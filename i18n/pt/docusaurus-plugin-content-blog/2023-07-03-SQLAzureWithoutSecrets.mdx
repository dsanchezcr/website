...
image: https://raw.githubusercontent.com/dsanchezcr/website/main/static/img/SQLAzureWithoutSecrets/SQLAzureWithoutSecrets.jpg
...
![](pathname:///img/SQLAzureWithoutSecrets/AADEnabledSQLServer.jpg)
...
Exemplo:
![](pathname:///img/SQLAzureWithoutSecrets/AddingUser.jpg)
...
![](pathname:///img/SQLAzureWithoutSecrets/ManagedIdentity.jpg)
...
Exemplo:
![](pathname:///img/SQLAzureWithoutSecrets/AddingManagedIdentity.jpg)
...
- [SQL Azure - Usando a Autenticação do Active Directory do Azure](https://learn.microsoft.com/azure/azure-sql/database/authentication-aad-overview?WT.mc_id=DT-MVP-5005361)