...
Para autenticar no Azure DevOps, você pode usar um token de acesso pessoal com acesso de leitura ao código. E digite seu nome de usuário e PAT no GitHub e, em seguida, clique em "Enviar".
